...
\item
	...
	\begin{itemize}
		\resitem{Worked on the core project (trip-service) which talks with DB and provides uniform API for all the innouse products}
		\resitem{Worked on Event Driven Architecture to make the system more responsive. Tech Used: Mongo, Kafka, Oracle}
	\end{itemize}
