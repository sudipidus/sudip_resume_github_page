...
\begin{itemize}
\item
	\ressubheading{Cleartrip}{JPNagar, Bangalore}{Senior Software Engineer L4}{October  2019 - Present}
	\begin{itemize}
...
\resitem{ Contributed to the platform team of cleartrip (core service providing in house API interfacing the main relational persistence, communication applications, application interfacing with monitoring agents like newrelic)}
