...
\begin{itemize}
\item
	\ressubheading{Udacity}{Online Platform}{Machine Learning Engineer Nano degree}{August 2017 - ongoing}
	\begin{itemize}
		\resitem{Relevant subjects: Python scikit, Machine learning fundamentals, Milestone projects, Introduction  to Deep Learning via Google's Tensorflow
		}		
	\end{itemize}
\item
